...
def stockSelltrailingStop(name, share, percentage):
    try:
        res = rs.orders.order_sell_trailing_stop(   name, 
                                                    ...
                                                    jsonify=True)
        print(res)
        cSVSellLog.add(getTimeNow(), res)
    except: 
        print("order_sell_trailing_stop ", name, "does not exist")
        cSVSellLog.add(getTimeNow(), "order_sell_trailing_stop " + name + "does not exist")
        return False  
    ...
    try:
        ...
        cSVSellLog.add(getTimeNow(), "order_sell_trailing_stop failed")
